...
#define DBGPRINT(msg, args...)                                                 \
	printk(KERN_INFO "lfdd %s: " msg, __func__, ##args);
#else
#define DBGPRINT(msg, args...)                                                 \
	do {                                                                   \
	} while (0);
...
unsigned int lfdd_cal_pci_addr(unsigned char bus, unsigned char dev,
			       unsigned char fun, unsigned char reg);
